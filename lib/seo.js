...
export function createWebApplicationJsonLd() {
  return {
    ...
    offers: {
      ...
      price: "0",
      priceCurrency: "USD",
      description: "3 free generations, paid plans from $9/month",
    },
    featureList: [
      "AI cover letter generator",
      "250 and 400 word cover letters",
...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    answer:
      "You get 3 free generations when you sign up. Each generation produces five documents: two cover letter lengths, a recruiter email, a LinkedIn message, and an ATS version.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Premium subscribers can download a ZIP file with cover letters exported as PDFs and other materials as text files, organized by company and job title.",
  },
];
